...
class OceanSoundScreen extends StatelessWidget {
  const OceanSoundScreen({super.key});
  ...
  Future<void> openVideo() async {
    final url = Uri.parse(
      "https://youtu.be/E7qRkUYu580?si=34uaoaErzLPBgj-I",
    );
                ...
                child: Row(
                  children: [
                    CircleAvatar(
                      radius: 45,
                      backgroundImage:
                      AssetImage("assets/icons/ocean.png"),
                    ),
