...
class RainSoundScreen extends StatelessWidget {
  const RainSoundScreen({super.key});
  ...
  Future<void> openVideo() async {
    final url = Uri.parse(
      "https://youtu.be/mPZkdNFkNps?si=_hd-NS-KMACtpnkz",
    );
  ...
  Widget build(BuildContext context) {
    return Directionality(
      ...
      child: Scaffold(
              ...
              SingleChildScrollView(
                ...
                child: Row(
                  children: [
                    ...
                    _chip("assets/icons/headphone1.png", tr("audioAvailable")),
                  ],
                ),
              ),
                ...
                Column(
                  children: [
                    ...
                    SingleChildScrollView(
                      ...
                      child: Row(
                        children: [
                          _step("assets/icons/listen.png", tr("listen")),
                          const SizedBox(width: 15),
                          _step("assets/images/breathe.png", tr("breathe")),
                          const SizedBox(width: 15),
                          _step("assets/images/relax.png", tr("relax")),
                        ],
                      ),
                    ),
                  ],
              ...
              _section(
                ...
                SingleChildScrollView(
                  ...
                  child: Row(
                    ...
                    children: [
                      _iconText("assets/images/brain.png",   tr("reduceStress")),
                      const SizedBox(width: 12),
                      _iconText("assets/images/sleep.png",  tr("improveSleep")),
                      const SizedBox(width: 12),
                      _iconText("assets/images/tension.png",    tr("relieveTension")),
                      const SizedBox(width: 12),
                      _iconText("assets/images/boost.png", tr("boostMood")),
                    ],
                  ),
                ),              ),
        ...
        /// 🔹 NAV BAR (YOUR EXISTING)
        bottomNavigationBar: const SizedBox(), // replace with PatientBottomNav if needed
      ),
    );
  }
